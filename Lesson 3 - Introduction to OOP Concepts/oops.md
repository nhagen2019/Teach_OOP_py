...
Python has been an object-oriented language since it existed. Because of this, creating and using classes and objects is easy. This chapter helps you become an expert in using Python's object-oriented programming. If you do not have any previous experience with object-oriented programming (OOP), you may want to consult an introductory course on it or at least a tutorial of some sort so that you have a grasp of the basic concepts. However, here is a small introduction of OOP to bring you at speed −
